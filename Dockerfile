...
WORKDIR /src
COPY ["TestSecApplication1/TestSecApplication1.csproj", "TestSecApplication1/"]
RUN dotnet restore "./TestSecApplication1/TestSecApplication1.csproj"
COPY . .
WORKDIR "/src/TestSecApplication1"
